...
export default function LandingPage() {
  const features = [
    {
      icon: <ChatAlt2Icon className="w-8 h-8 text-sky-500" />,      title: 'Natural Language',
      description: 'Add tasks using simple, everyday language. Our AI understands what you mean.'
    },
    {
      icon: <LightningBoltIcon className="w-8 h-8 text-sky-500" />,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-sky-900 to-emerald-900 text-white">
      {/* Navigation */}
      <nav className="container mx-auto px-6 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <SparklesIcon className="w-8 h-8 text-sky-400" />
            <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-sky-400 to-emerald-400">
              TaskFlow AI
            </span>
          </div>
          <Link 
            to="/home" 
            className="px-6 py-2 bg-gradient-to-r from-sky-500 to-emerald-600 rounded-full text-white font-medium hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-sky-500/30"
          >
      ...
      >
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            className="inline-block mb-6 px-4 py-2 bg-sky-900/30 backdrop-blur-sm rounded-full border border-sky-500/30 text-sky-300 text-sm"
          >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-20">
            <Link
              to="/home"
              className="px-8 py-4 bg-gradient-to-r from-sky-500 to-emerald-600 rounded-full text-white font-medium text-lg hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-sky-500/30"
            >
          ...
          >
            ...
            <p className="text-lg text-gray-200">
              Try saying: <span className="text-sky-300">"Schedule a meeting with John tomorrow at 2pm about the project"</span>
            </p>
          </motion.div>
        </div>
      </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700 hover:border-sky-500/30 transition-colors"
              >
      ...
      <div className="py-20 text-center">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <Link
            to="/home"
            className="inline-block px-8 py-4 bg-gradient-to-r from-sky-500 to-emerald-600 rounded-full text-white font-medium text-lg hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-sky-500/30"
          >
            Get Started for Free
          </Link>
        </div>
