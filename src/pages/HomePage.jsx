    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-sky-900 to-emerald-900 text-white">
      ...
      <nav className="container mx-auto px-6 py-6">
        <div className="flex items-center justify-between">
          ...
          <span className="px-4 py-2 text-sky-100 bg-sky-900/50 rounded-full text-sm font-medium">
      ...
      >
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-white to-sky-200">
            Your Tasks
          </h1>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/10">
            <div className="space-y-6">
              ...
              <div className="relative flex items-center my-4">
                ...
                <span className="flex-shrink mx-4 text-sm text-sky-300">or add manually</span>
                <div className="flex-grow border-t border-white/10"></div>
              </div>
